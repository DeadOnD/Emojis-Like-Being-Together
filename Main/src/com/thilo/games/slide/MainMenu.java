...
import com.thilo.games.slide.Game.Difficulty;
import com.thilo.games.slide.render.Background;
import com.thilo.games.slide.render.Block;
import com.thilo.games.slide.render.Label;
import com.thilo.games.slide.render.TextEntry;
import com.thilo.games.slide.render.TextEntry.TextBoxType;
...
public class MainMenu extends CCLayer implements KeyHandler {
	...
	private CCMenu getMenu() {	
		...
		CCMenuItem help1 = getTextItem(R.string.about, "showAbout");
